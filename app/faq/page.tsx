...
export const metadata: Metadata = {
  ...
  description:
    'Find answers to common questions about Doxsify file security, supported formats, pricing, and more.',
};
...
const faqCategories = [
  {
    ...
    questions: [
      {
        q: 'Are my files safe on Doxsify?',
      ...
      {
        q: 'Is Doxsify GDPR compliant?',
        a: 'Yes. Doxsify is fully GDPR compliant. We process only the minimum data necessary, provide data deletion on request, and maintain transparent privacy practices. See our Privacy Policy for full details.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: 'What file formats does Doxsify support?',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'You can cancel your subscription at any time from your account dashboard or by emailing support@doxsify.com. Your access continues until the end of the billing period.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: 'Do I need an account to use Doxsify?',
      ...
      {
        q: 'Can I use Doxsify on multiple devices?',
        a: 'Yes. Doxsify is web-based and works on any device with a modern browser — desktop, tablet, or mobile. Your account is accessible across all devices.',
      },
    ],
  },
];
        ...
        <section className="pt-28 pb-16 bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Everything you need to know about Doxsify. Can&apos;t find an answer?{' '}
