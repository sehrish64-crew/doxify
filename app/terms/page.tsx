        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900">
          <div className="max-w-3xl mx-auto">
            ...
            <LegalSection title="5. Subscriptions and Payments">
              <p>
                Paid subscriptions are billed in advance on a monthly or annual basis. Payments are processed by Mollie.com, our Merchant of Record. By subscribing, you authorize recurring charges until you cancel. All prices are in USD unless otherwise stated.
              </p>
            </LegalSection>
