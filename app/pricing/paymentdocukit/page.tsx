...
export default function PaymentDoxsifyPricingPage() {
    ...
    return (
        <>
            ...
            <main className="min-h-screen">
              ...
              This is the alternate pricing page from the Payment.Doxsify version, showing the same plan details and subscription options.
            </p> */}
                            ...
                            {plans.map((plan) => (
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                    >
                                        <Link href={plan.name === 'Premium' ? '/checkout/premium' : '/pricing/paymentdoxsify'}>
                                            {plan.cta}
                                        </Link>
                                    </Button>
                                </div>
