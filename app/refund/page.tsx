...
export const metadata: Metadata = {
  title: 'Refund Policy',
  description: 'Learn about Doxsify\'s 30-day money-back guarantee and refund process.',
};
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900">
          <div className="max-w-3xl mx-auto">
            ...
            <LegalSection title="6. Contact for Refunds">
              <p>
                Email: <a href="mailto:refunds@doxsify.com" className="text-blue-600 dark:text-blue-400 hover:underline">refunds@doxsify.com</a>
              </p>
            </LegalSection>
          </div>
        </section>
