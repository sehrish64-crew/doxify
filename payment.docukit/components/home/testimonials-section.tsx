...
const testimonials = [
  {
    ...
    avatar: 'SJ',
    rating: 5,
    text: "Doxsify has completely transformed how our team handles documents. The PDF compression tool alone saves us gigabytes of storage every week.",
  ...
  },
  {
    ...
    avatar: 'MC',
    rating: 5,
    text: "I convert between image formats constantly for client work. Doxsify is the fastest tool I've used — results are ready before I even blink.",
  ...
  },
  {
    ...
    avatar: 'LT',
    rating: 5,
    text: "We process hundreds of forms daily. Doxsify handles our batch conversions without breaking a sweat. The Premium plan is worth every penny.",
      ...
      <div className="container-max">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            See what professionals say about Doxsify.
          </p>
        </div>
